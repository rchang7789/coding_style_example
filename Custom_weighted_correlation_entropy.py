...
#=============================================================================
#Full output example usage


#*************** for renko ***************
#data_set_close
#df_y = data_set_close.iloc[:,0]
##****************************************
...
#slope_output0, corr_output0 = trend().weighted_pearson_corr(df_y, custom_weight_val().
#                              equally_weighted_slice())

#slope_output1, corr_output1 = trend().weighted_pearson_corr(df_y, custom_weight_val().
#                              linearly_weighted_slice(0.25, 1, True))

#slope_output2, corr_output2 = trend().weighted_pearson_corr(df_y, custom_weight_val().
#                              linearly_weighted_slice(0.25, 1, False))

#slope_output3, corr_output3 = trend().weighted_pearson_corr(df_y, custom_weight_val().
#                              logarithmically_weighted_slice(0.25, 1, 0.015, True))

#slope_output4, corr_output4 = trend().weighted_pearson_corr(df_y, custom_weight_val().
#                              logarithmically_weighted_slice(0.25, 1, 0.015, False))





#spearmanr_output = trend().spearman_rank_corr(df_y)

#kendallt_output = trend().kendall_tau_corr(df_y)

#entropy_output = trend().relative_entropy(df_y, True)

#ma_output = trend().simple_moving_average(df_y)

#ma_diff_output = trend().simple_moving_average_cross_diff(df_y, 0.5)
